...
# ADD LINK32 kernel32.lib user32.lib ws2_32.lib /nologo /dll /map /machine:I386 /out:"DLL_Release/ptypes21.dll"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir            ..\so\           	copy             DLL_Release\ptypes21.lib             ..\so\            	copy             DLL_Release\ptypes21.dll             ..\so\ 
...
# ADD LINK32 kernel32.lib user32.lib ws2_32.lib /nologo /dll /incremental:no /debug /machine:I386 /out:"DLL_Debug/ptypes21.dll" /pdbtype:sept
